...
aws s3 cp /app/modelo s3://312019940349-pest-mod-res-ensi-west-2/backup/20260202_0830 --recursive

#para salir de la sesion del contenedor y volver al host local
exit

#Crear una carpeta para el respaldo localmente
mkdir respaldo_mod-res-ensi_west2_20260202_0830

#ingresar a la carpeta creada
cd respaldo_mod-res-ensi_west2_20260202_0830

#descargar datos del bucket a la maquina local (.) significa la carpeta actual donde está la consola.
aws s3 sync s3://312019940349-pest-mod-res-ensi-west-2/backup/20260202_0830 . --region us-west-2
...
aws ecs execute-command `
  ...
  #una vez dentro del contenedor, ejecutar el siguiente comando para respaldar la carpeta /app/modelo en el bucket s3
aws s3 cp /app/modelo s3://312019940349-pest-mod-res-ensi-west-2/backup/20260201_1620 --recursive

#para salir de la sesion del contenedor y volver al host local
exit

#Crear una carpeta para el respaldo localmente
mkdir respaldo_mod-res-ensi_20260201_1620

#ingresar a la carpeta creada
cd respaldo_mod-res-ensi_20260201_1620

#descargar datos del bucket a la maquina local (.) significa la carpeta actual donde está la consola.
aws s3 sync s3://312019940349-pest-mod-res-ensi-east-2/backup/20260201_1620 . --region us-east-2