...
# Parámetros básicos
nombre_proyecto = 'pest-talabre'
region_name = 'us-west-2'
ejecutable_agente = 'agent_hp.exe'
nombre_modelo_pest_a_ejecutar = 'talabre'
master_host = 'master.pest-talabre.local'
pest_port = 4004
...
security_group_id = 'sg-046258e1f78ef0fd7'  # Reemplaza con tu grupo de seguridad  (SG for ECS tasks)
