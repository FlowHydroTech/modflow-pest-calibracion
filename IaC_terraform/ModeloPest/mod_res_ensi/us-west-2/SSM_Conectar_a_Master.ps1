...
aws s3 cp /app/modelo s3://312019940349-pest-mod-res-ensi-west-2/backup/20260118_0020 --recursive

#para salir de la sesion del contenedor y volver al host local
exit

#Crear una carpeta para el respaldo localmente
mkdir respaldo_mod-res-ensi_west2_20260118_0020

#ingresar a la carpeta creada
cd respaldo_mod-res-ensi_west2_20260118_0020

#descargar datos del bucket a la maquina local (.) significa la carpeta actual donde está la consola.
aws s3 sync s3://312019940349-pest-mod-res-ensi-west-2/backup/20260118_0020 . --region us-west-2
