...
agent_count_max = 1498   #máximo número de agentes permitidos en la region us-west-2 de AWS. 1500 vcpu (2 master + 1498 agentes) Fargate.
minutes_wait_between_checks = 10     # Se establecen 10 minutos para que los jobs tengan tiempo de levantar las máquininas.
...
def stop_task(task_arn, region="us-west-2", cluster_name=None, reason="Stopped manually via script"):
    """
